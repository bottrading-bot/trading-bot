# =========================
# 🚀 PRO BOT (COMPOUNDING + AUTO SCALE)
# =========================
...
ALPACA_API_KEY = "PKLF5SOMQPDYHXGGV6QO2HR7ZU"
ALPACA_SECRET_KEY = "8WC1RLHwm8eoHubKJFG74FMBWcn1iZmJQW7jKrMXFHpZ"
...
def dynamic_risk():
    ...
    # Gewinnphase → aggressiver
    if capital > peak_capital:
        peak_capital = capital
        return BASE_RISK * 1.5

    # Drawdown → vorsichtiger
...
def trade():
    ...
    for stock in stocks:
        ...
        if stock not in positions:
            ...
            breakout = price >= recent_high * 0.99

            if score > 0.65 and breakout:
        ...
        if pos:
            ...
            if price <= trailing or score < 0.55:
                ...
                print(f"💰 Profit: {profit:.2f} | Capital: {capital:.2f}")
...
def auto_trade_loop():
    print("🤖 Trading gestartet (COMPOUND MODE)...")
