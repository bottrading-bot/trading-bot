    ...
    while True:
        ...
        for stock in stocks:
            ...
            if stock not in positions:
                if (
                    regime == "BULL"
                    and pred > 0.68          # 🔥 mehr Trades
                    and trend
                    and 40 < rsi < 55       # 🔥 besserer Entry
            ...
            # ================= SELL =================
                ...
                # 🔥 NEU: PROFIT LOCK (ZUERST CHECKEN!)
                if price > entry * 1.01 and price < peak:
                    capital += qty * price
                ...
                if (
                    ...
                    if profit > 0:
                        send_message(f"✅ PROFIT {stock}: {round(profit,2)}")
                    else:
                        send_message(f"❌ LOSS {stock}: {round(profit,2)}")
