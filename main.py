...
ALPACA_API_KEY = "AKZYH2YFIKRR5OTZR5KW73GUGR"
ALPACA_SECRET_KEY = "G6WaMY4ZGrr1qhv2CKUbaNsj26nAMidwzjAYdyiYTWRJ"

client = TradingClient(ALPACA_API_KEY, ALPACA_SECRET_KEY, paper=False)

# =========================
# HELPERS (MUSS OBEN SEIN)
# =========================
    ...
    while True:
        ...
        for stock in stocks:
            ...
            if stock not in positions:
                ...
                if (
                        pred > 0.45
                        and (trend or momentum > -0.001)
                        and 20 < rsi < 80
                ):
                    capital = get_real_capital()
                    print("💰 BUYING POWER:", capital)
