...
MAX_POSITIONS = 2   # 🔥 jetzt 4 Trades möglich
MAX_DAILY_LOSS = 0.05
MAX_DRAWDOWN = 0.15
        ...
        while True:
            ...
            for stock in stocks:
                ...
                if stock not in positions:
                    ...
                    if (
                            pred > 0.42  # 🔥 lockerer
                            and 15 < rsi < 85  # 🔥 breiter
                            and (trend or momentum > -0.002)  # 🔥 fast immer erlaubt
                    ):
                        capital = get_real_capital()

                        # 🔥 falls kein echtes Kapital → skip
                        if capital < 1:
                            continue
                        ...
                        # 🔥 aggressiver Einsatz
                        amount = min(amount, capital * 0.6)

                        # 🔥 MINIMUM FIX (SEHR WICHTIG)
