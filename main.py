    ...
    while True:
        ...
        for stock in stocks:
            ...
            if stock not in positions:
                ...
                if (
                        pred > 0.48  # 🔥 früher war effektiv das Niveau
                        and 30 < rsi < 70  # 🔥 viel breiter
                        and trend or momentum > 0
                        and price > ma20 * 0.995  # 🔥 bisschen Spielraum
                ):
                    amount = position_size(capital, vol, pred, regime)

                    # 🔥 WICHTIG: kleinere Trades = mehr Trades möglich
