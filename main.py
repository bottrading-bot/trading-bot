...
ALPACA_API_KEY = "AKOLU4VMLB5YCRA7XB2AZNPJZY"
ALPACA_SECRET_KEY = "Gd6RHxREsfCd4P71HUA6ewbagErVyGvUACgBhiXJkZjg"
    ...
    while True:
        ...
        for stock in stocks:
            ...
            if stock not in positions:
                ...
                if (
                        regime == "BULL"
                        and pred > 0.48  # 🔥 nicht zu streng
                        and trend
                        and 30 < rsi < 70  # 🔥 breiter Bereich
